        ...
        <div class="col-lg-10 col-xl-8">
            ...
            <div class="form-card">
                <div class="card-header-gradient">
                    <h2 class="mb-1 fw-bold">Tambah Soal Baru</h2>
                    <p class="mb-0 opacity-75">Lengkapi formulir di bawah untuk menambahkan kuesioner baru</p>
                </div>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="perusahaan" name="perusahaan" required>
                                <option value="" disabled selected>-- Hubungkan dengan Perusahaan --</option>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="factor-group">
                                <div class="factor-item">
                                    <input type="radio" value="core" id="factor_core" name="factor" required>
                                    <label class="factor-label" for="factor_core">
                                        <i class="fas fa-star me-2"></i> Core Factor
                                    </label>
                                </div>
                                <div class="factor-item">
                                    <input type="radio" value="secondary" id="factor_secondary" name="factor" required>
                        ...
                        <div class="mb-5">
                            ...
                            <textarea class="form-control" id="soal" name="soal" rows="3" placeholder="Masukkan pertanyaan kuesioner..." required></textarea>
                        </div>
                        ...
                        <div class="row align-items-center mb-4 g-3">
                            <div class="col-md-7">
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-control" id="jawaban_<?= $opt ?>" name="jawaban_<?= $opt ?>" placeholder="Jawaban Opsi <?= $upper ?>..." required>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="d-flex align-items-center justify-content-md-end gap-3">
                                    ...
                                    <div class="value-chips">
                                        <?php for ($v = 1; $v <= 4; $v++): ?>
                                        <div class="chip-item">
                                            <input type="radio" id="value_<?= $opt ?>_<?= $v ?>" name="value_<?= $opt ?>" value="<?= $v ?>" required onclick="updateValues()">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-5 pt-4 border-top">
                            ...
                            <button type="submit" name="tambah" class="btn btn-gradient-primary" id="submitBtn" disabled>
                                <i class="fas fa-plus-circle me-2"></i> Simpan Soal
                            </button>
                        </div>
...
<script>
    // Function to check if there are any duplicate selected values
    function checkDuplicateValues() {
        ...
        if (!allSelected) return true; // Keep button disabled until all are selected
    ...
    function updateValues() {
        ...
        // Visual feedback for errors (optional but good)
        if (isDuplicate && document.querySelectorAll('input[type="radio"]:checked').length === 4) {
            // All selected but duplicate
            console.warn("Ada nilai ganda!");
        }
    }

    // Attach event listeners to all value radio buttons
    document.querySelectorAll('input[type="radio"]').forEach(button => {
        button.addEventListener('change', updateValues);
    });
</script>
